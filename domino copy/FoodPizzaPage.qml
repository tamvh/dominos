...
Rectangle {
    ...
    function appendFood(description, min_size, objdata, category, foodname, price, image, img_cache, oriprice, promtype) {
        ...
        foodsModel.append({description: description, visible_price: visible_price, min_size: min_size, objdata: objdata, category: category, name: foodname, namelatin: latin, price: priceString, image: image, img_cache: img_cache,
