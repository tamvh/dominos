...
QString CommonFunction::filterPizzaName(QString dataName) {
    return dataName.replace("12\" Cheesy Crust", "").
            replace("12\" Handtossed", "").
            replace("12\" New York Crust", "").
            replace("12\" Thin Crust", "").
            replace("7\" Handtossed", "").
            replace("7\" Thin Crust", "").
            replace("9\" Cheesy Crust", "").
            replace("9\" Handtossed", "").
            replace("9\" New York Crust", "").
            replace("9\" Thin Crust", "").
            replace("9\" Thin Cheesy Crust", "").
            replace("9\" Thin Crust Chessy", "").
            replace("9\" Thin Crust Chessy", "").
            replace("12\" Thin Cheesy Crust ","").
            replace("Side ","");
}
