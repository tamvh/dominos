...
public:
    ...
    Q_INVOKABLE void insertItem(const QString& name, const QString& price, const QString &oriprice, const QString &promtype);
...
signals:
    ...
    void addItem(const QString& name, long quantity, long long price, const QString& amount, const QString &oriprice, const QString &promtype);
    void cancelBillItem();
